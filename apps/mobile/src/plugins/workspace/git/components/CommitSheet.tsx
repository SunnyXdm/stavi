          ...
          <ScrollView style={styles.content} bounces={false}>
            ...
            {stagedFiles.slice(0, 10).map((f) => (
              <View key={f.path} style={styles.fileRow}>
                <View style={[styles.statusBadge, { backgroundColor: getStatusBgColor(f.status) }]}>
...
const styles = StyleSheet.create({
  ...
  warningBadge: {
    ...
    paddingHorizontal: spacing[2], paddingVertical: 2, borderRadius: radii.sm,
  },
  warningText: {
    fontSize: typography.fontSize.xs, color: colors.semantic.warning,
  ...
  statusBadge: {
    width: 18, height: 18, borderRadius: radii.sm, alignItems: 'center', justifyContent: 'center',
  },
  ...
  filePath: {
    ...
    fontFamily: typography.fontFamily.mono, color: colors.fg.secondary,
  },
  ...
  messageInput: {
    ...
    paddingHorizontal: spacing[4], paddingVertical: spacing[3],
    fontSize: typography.fontSize.base, color: colors.fg.primary,
    marginTop: spacing[4], minHeight: 80, maxHeight: 160, textAlignVertical: 'top',
  },
  commitButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing[2],
    backgroundColor: colors.accent.primary, borderRadius: radii.md,
    paddingVertical: spacing[3], marginTop: spacing[3],
  },
